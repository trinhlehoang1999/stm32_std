...
//if(EXTI_GetITStatus(EXTI_Line12)==SET)
	...
	GPIO_ResetBits(GPIOA,GPIO_Pin_6);	
		t=0;
		//if(f==GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_12))  EXTI_ClearITPendingBit(EXTI_Line12); 
}
...
//	}
	...
	if (trigger == Trigger_Falling) {
		GPIO_InitStruct.GPIO_Mode = GPIO_Mode_IPU;//2 TRANG THAI NGUOC NHAU DE KHI NHAN NUT LA SE  RA NGAT
	...
	EXTI_InitStruct.EXTI_Trigger = (EXTITrigger_TypeDef) trigger; // ep kieu bien trigger vao ham EXTITrigger_TypeDef
